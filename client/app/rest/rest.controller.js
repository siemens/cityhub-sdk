    ...
    $scope.apis = [
      ...
      {httpMethod: 'POST', path: '/api/devices/:deviceId', description: 'Sets configuration of the specified city hub device',
        sampleRequest: {path: '/api/devices/ch1', body: {id: 'ch1', info: 'city hub 1', latitude: 36.165036, longitude: -86.7840599, sensors: [
          {id: 'AvailableParkingSpaces', index: 1, info: 'Number of available parking spaces in the area, 0-500', type: 'int', isBookable: true, pricePerHour: 1, minValue: 0, maxValue: 500, value: 5, timestamp: '1970-01-01T00:00:00.000Z'},
          {id: 'AvailableBikes', index: 2, info: 'Number of available bikes for rent in the area, 0-20', type: 'int', isBookable: true, pricePerHour: 5, minValue: 0, maxValue: 20, value: 10, timestamp: '1970-01-01T00:00:00.000Z'},
          ...
          {id: 'Proximity', index: 8, info: 'Proximity sensor based e.g. on ultra-sound sensor, 0-800cm', type: 'int', minValue: 0, maxValue: 800, value: 800, timestamp: '1970-01-01T00:00:00.000Z'},
          ...
          {id: 'TrafficDensity', index: 10, info: 'Normalized traffic density, 0-100', type: 'int', minValue: 0, maxValue: 100, value: 50, timestamp: '1970-01-01T00:00:00.000Z'}]
        }}
      },
